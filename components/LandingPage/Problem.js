const PAIN_POINTS = [
  ...
  { icon: '📵', text: 'صعوبة متابعة الصحة عن بُعد يوميًا، سواء لنفسك أو لمن تهتم به' },
    ...
    <section className="px-6 py-16 sm:py-24 bg-white">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-2xl sm:text-heading font-bold text-gray-900 mb-4">
          متابعة صحة كبار السن ليست سهلة كما ينبغي
        </h2>
        <p className="text-lg sm:text-2xl text-gray-600 mb-12">
          كبار السن ومن يعتني بهم، من أفراد العائلة أو مقدمي الرعاية، يواجهون
          تحديات حقيقية كل يوم
        </p>
      </div>
